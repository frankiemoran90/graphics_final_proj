...
void moon_phases(hittable_list &world, point3 moon_pos) {
    ...
    world.add(make_shared<sphere>(moon_pos, 5, moon_material));


    auto sunlight = make_shared<diffuse_light>(color(30, 30, 30));
...
//-----------------------------------------------------------------------------
// moon_and_earth -- video of moon and earth
//-----------------------------------------------------------------------------
    ...
    for (int frame = 0; frame < num_frames; frame++) {
        ...
        switch (worldid) {
            ...
            case 3:
                ...
                break;
            case 4: 
                moon_and_earth(world, moon_phase_pos, frame);
                break;
            default:
